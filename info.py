...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/A2ZSupportX')  # Support group link (make sure bot is admin)
...
AUTH_CHANNELS = [int(channels_id) for channels_id in environ.get('AUTH_CHANNELS', '-1002204000222').split() if re.match(r'^-?\d+$', channels_id)]  # Channels for force sub (make sure bot is admin)
...
# ============================
QR_CODE = environ.get('QR_CODE', 'ɴᴏ ᴀᴠᴀɪʟᴀʙʟᴇ ʀɪɢʜᴛ ɴᴏᴡ')    # QR code image for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Bisal:Bisal123@bisal.qt3ma.mongodb.net/?retryWrites=true&w=majority&appName=Bisal")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'FilesA2Z') # Collection name (default: dreamcinezone_files)
...
SHORTENER_API = environ.get("SHORTENER_API", "a7ac9b3012c67d7491414cf272d82593c75f6cb") # Shortener API key
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/WeRbackA2Z') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/WeRbackA2Z') # Owner link for the bot
...
CUSTOM_FILE_CAPTION = environ.get("[A2ZOFFICIAL]", f"{script.CAPTION}")   # Custom caption for files
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', 'https://wonderful-jeannette-techentra-bc547654.koyeb.app/'))
